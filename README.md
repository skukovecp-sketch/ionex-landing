...
- [x] **EN VIVO desde 2026-08-12: https://ionex.agency** — comprado en Hostinger ($3.99 primer año, renueva a $35.99/año el 2027-08-12), desplegado en Vercel (proyecto `ionex-landing-akl1`, repo `github.com/skukovecp-sketch/ionex-landing`), DNS conectado (CNAME `www` → Vercel, A `@` → `216.198.79.1`), SSL activo
